...
WbDeviceTag accelerometer2;
double accelerometer_coords2[3];

WbDeviceTag accelerometer3;
double accelerometer_coords3[3];

WbDeviceTag accelerometer4;
double accelerometer_coords4[3];
...
void print_help()
{
  ...
  printf("[S]            - Show the speed of the car\n");
...
void update_imu_acceleration()
{
  ...
  const double *coords2 = wb_accelerometer_get_values(accelerometer2);
  const double *coords3 = wb_accelerometer_get_values(accelerometer3);
  const double *coords4 = wb_accelerometer_get_values(accelerometer4);
  memcpy(accelerometer_coords, coords, sizeof(accelerometer_coords));
  memcpy(accelerometer_coords2, coords2, sizeof(accelerometer_coords2));
  memcpy(accelerometer_coords3, coords3, sizeof(accelerometer_coords3));
  memcpy(accelerometer_coords4, coords4, sizeof(accelerometer_coords4));
...
int data_export(FILE *p)
{
  ...
  else
  {
    ...
    fprintf(p, "%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f\n",
            ...
            accelerometer_coords2[X], accelerometer_coords2[Y], accelerometer_coords2[Z],
            accelerometer_coords3[X], accelerometer_coords3[Y], accelerometer_coords3[Z],
            accelerometer_coords4[X], accelerometer_coords4[Y], accelerometer_coords4[Z],
...
void sensor_init()
{
  ...
  wb_accelerometer_enable(accelerometer, time_step);
    ...
    accelerometer2 = wb_robot_get_device("accelerometer2");
    wb_accelerometer_enable(accelerometer2, time_step);

    accelerometer3 = wb_robot_get_device("accelerometer3");
    wb_accelerometer_enable(accelerometer3, time_step);

    accelerometer4 = wb_robot_get_device("accelerometer4");
    wb_accelerometer_enable(accelerometer4, time_step);
